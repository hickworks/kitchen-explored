...
<ComparisonTable
  ...
  rows={[
    [{text: "Cangshan", href: "https://amzn.to/3xDFWgF"}, {text: "4.5/5"}, {text: "Buy From Amazon", href: "https://amzn.to/3xDFWgF", isButton: true}],
    [{text: "Henckels", href: "https://amzn.to/3VAaIPJ"}, {text: "4.5/5"}, {text: "Buy From Amazon", href: "https://amzn.to/3VAaIPJ", isButton: true}]
  ]}
/>
