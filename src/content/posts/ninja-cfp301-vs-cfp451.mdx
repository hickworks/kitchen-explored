...
<ComparisonTable
  ...
  rows={[
    ...
    [{text: "Ninja cfp451", href: "https://amzn.to/3KVDCVs"}, {text: "4.5/5"}, {text: "Buy From Amazon", href: "https://amzn.to/3KVDCVs", isButton: true}]
  ]}
/>

* * *

## [Ninja CFP451](https://amzn.to/44HoiTL)
...
## [Ninja CFP301](https://amzn.to/3PvLAaL)
